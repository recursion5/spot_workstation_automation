...
This repository is in **Phase 1: bootstrap and discovery**. It does not yet provision replacement PCs.

Canonical intent: [project-spec.md](project-spec.md). Agent rules: [AGENTS.md](AGENTS.md). Current state: [docs/STATUS.md](docs/STATUS.md).
...
- what launches SPOT (Citrix / SPOTLauncher / SPOTWeb / ConnectLink — discover, do not assume);
...
The POS application is **Xplor Spot** ([xplorspot.com](https://xplorspot.com)). Vendor documentation describes both a Citrix + SPOTLauncher path and a newer SPOTWeb + ConnectLink path. The specimen is expected to use a Citrix-receiver-style local setup; confirm on disk.
