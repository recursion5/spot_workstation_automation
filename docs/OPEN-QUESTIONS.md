...
| Q-074 | NAS **share path** and how the USB authenticates to read secrets? | **Path answered 2026-08-27:** `\\dsm.vogueclean.int\spot-rebuild` (ADR-0013). How the USB authenticates (NAS user vs guest) still open. |
