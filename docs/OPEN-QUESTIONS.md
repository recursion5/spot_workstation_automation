...
| Q-074 | NAS **share path** and how the USB authenticates to read secrets? | **Path answered 2026-08-27:** `\\dsm.vogueclean.int\spot-rebuild`. **Auth method:** NAS user (password in the pack, not git). **Username** still to be named when the share exists. |
