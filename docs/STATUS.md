...
3. Official **SPOTLauncherSetup 1.1.169.3** and **Citrix Workspace 2603.10 x64** offline installer are on the pack. Still missing SS Client **2.2.1** setup (leftover Downloads are 2.0.x).
