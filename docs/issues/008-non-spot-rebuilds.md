...
| Video wall | Zenith | Windows 10 Pro 19044 (`Z-SSTATION` / 10.0.253.164) | Windows 11 Pro | SS Client 2.2.1 + **CallerIdOverlay** logon task; `Zenith User` not admin; AutoAdminLogon=1 |
